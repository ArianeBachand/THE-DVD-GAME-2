...
class Boid
{
  ...
  void render()
  {
    ...
    //imgStar = loadImage("etoile2.png");
    //imageMode(CORNER);
    //image(imgStar, position.x, position.y);
   
   
   //fill(200, 86, 9); //nageoires oranges
   // ellipse(10.0f, 10.0f, radius * 1.0f, radius * 0.5f);
   // ellipse(-10.0f, 10.0f, radius * 1.0f, radius * 0.5f);
   // //ellipse(1.0f, 1.0f, radius * 2.0f, radius * 2.5f);
    
   //  fill(227, 237, 238); //corps blanc
   //   ellipse(0.0f, radius * 2.0f, radius * 2.0f, radius * 5.0f);
      
   //   fill(200, 86, 9); //queue
   // ellipse(0.0f, radius * 5.0f, radius * 1.0f, radius * 3.0f);
   
   // fill(94, 78, 71); //yeux
   // ellipse(7.5f, -9.0f, radius * 0.5f, radius * 0.5f);
   // ellipse(-7.5f, -9.0f, radius * 0.5f, radius * 0.5f);
   // //ellipse(1.0f, 1.0f, radius * 2.0f, radius * 2.5f);
    
   // fill(246, 115, 6); //tête orange
   // ellipse(0.0f, 0.0f, radius * 2.0f, radius * 2.5f);
   // //ellipse(1.0f, 1.0f, radius * 2.0f, radius * 2.5f);
    
   // fill(246, 115, 6); //corps orange
   //  ellipse(0.0f, radius * 2.0f, radius * 2.0f, radius * 1.5f);
     
   //  ellipse(0.0f, radius * 3.5f, radius * 2.0f, radius * 1.0f);

    //ellipse(4.0f, 0.0f, radius * 1.0f, radius * 1.0f);
    popMatrix();
  }
}
